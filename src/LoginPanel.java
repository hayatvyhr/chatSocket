...
public class LoginPanel extends JFrame {
    ...
    public LoginPanel() {
        try {
            aes = new AES(); // Create an AES instance
            aes.init(); // Initialize AES and generate a key
        } catch (Exception e) {
    ...
    private void login() throws RuntimeException {
        ...
        if (!email.isEmpty() && !username.isEmpty()) {
            try {
                ...
                String userencrypted = aes.encrypt(username);
                String emailencrypted = aes.encrypt(email);
                String loginInfo = "JOIN " + userencrypted + " " + emailencrypted;
